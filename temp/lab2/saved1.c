  ...
  */
  ...
  while(1) {
    ...
    if(FD_ISSET(tap_fd, &rd_set)){
      ...
      nwrite = sendto(net_fd, buffer, nread, MSG_CONFIRM, (const struct sockaddr *) &remote, sizeof(remote)); 
    ...
    if(FD_ISSET(net_fd, &rd_set)){
      ...
      nread = recvfrom(sock_fd, buffer, ntohs(plength), MSG_WAITALL, ( struct sockaddr *) &remote, &len); //TODO
